...
public class StepAdapter extends RecyclerView.Adapter<StepAdapter.StepHolder> {
    ...
    public StepHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
        View view = LayoutInflater.from(parent.getContext()).inflate(R.layout.view_holder_step, parent, false);
    ...
    class StepHolder extends RecyclerView.ViewHolder implements View.OnClickListener {
        ...
        StepHolder(View itemView) {
            super(itemView);
            stepNumber_tv = itemView.findViewById(R.id.step_number);
            stepTitle_tv = itemView.findViewById(R.id.step_shortDesc);
